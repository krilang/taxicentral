...
public enum Status {
	USER_ORDER, USER_CANCEL,USER_PREBOOK, // Objects from user to central -- USER CANCEL also to taxi...
	...
	CENTRAL_USER_CANCEL_CONF, CENTRAL_USER_ORDER_CONF, CENTRAL_USER_ORDER_Q, CENTRAL_TOUR_ENDED_CONF, // Objects from central to user
